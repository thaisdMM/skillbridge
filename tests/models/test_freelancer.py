...
class TestFreelancerCreate:
    ...
    def test_create_with_invalid_email_raises_error(
        ...
        with pytest.raises(ValueError) as exc_info:
            Freelancer.create(invalid_email, valid_name, valid_password)
    ...
    def test_create_with_invalid_password_raises_error(
        ...
        with pytest.raises(ValueError) as exc_info:
            Freelancer.create(valid_email, valid_name, invalid_password)
    ...
    def test_create_with_invalid_name_raises_error(
        ...
        with pytest.raises(ValueError) as exc_info:
            Freelancer.create(valid_email, invalid_name, valid_password)
...
class TestFreelancerFromStorage:
    ...
    def test_from_storage_freelancer_instance_with_valid_data(
        ...
        freelancer = Freelancer.from_storage(user_id, email, name, hashed, created_at)
